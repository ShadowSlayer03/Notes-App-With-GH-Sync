...
<div class="p-6 text-zinc-100 bg-[#0D0F12] h-full flex flex-col font-sans antialiased select-none">
	...
	{:else}
		<div
			class="px-4 text-zinc-100 bg-[#0D0F12] h-full flex flex-col font-sans antialiased select-none"
		>
